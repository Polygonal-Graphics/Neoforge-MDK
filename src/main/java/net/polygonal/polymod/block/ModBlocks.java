package net.polygonal.polymod.block;
...
{
    public static final DeferredRegister.Blocks BLOCKS = DeferredRegister.createBlocks(PolyMod.MOD_ID);
    ...
    // Used to automatically register a BlockItem when calling registerBlock
